...
func New(env *env.Env) *API {
	...
	a.Mux.HandleFunc("/api/"+version+"/desktop/{id}/start", a.isAuthenticated(a.desktopStart))
	a.Mux.HandleFunc("/api/"+version+"/desktop/{id}/stop", a.isAuthenticated(a.desktopStop))
